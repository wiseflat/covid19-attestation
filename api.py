...
parser.add_argument('motif', type=inputs.regex(regex_motif), required=True, help='motif (convocation|missions|handicap|sante|enfants|famille|sport_animaux|travail|achats)')
